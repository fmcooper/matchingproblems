...
from .enums import Instance_options, Extra_constraints, Optimisation_options
...
class Options_parser:
    ...
    def _stability_requirements_check(self, parser, instance_options, extra_constraints):
        if extra_constraints[Extra_constraints.STAB] and not instance_options[Instance_options.TWOPL]:
            parser.error('must have two sided preference lists when choosing stability')
    ...
    def parse(self, arguments):
        ...
        ################################################################################################# do a check that stability is only tested if twopl is given
        ...
        self._stability_requirements_check(parser, self.instance_options, self.extra_constraints)
        # print("instance_options", self.instance_options)
        # print("extra_constraints", self.extra_constraints)
        # print("optimisation_options", self.optimisation_options)
